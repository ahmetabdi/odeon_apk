...
public abstract class AmazingSimpleCursorAdapter extends SimpleCursorAdapter implements SectionIndexer, OnScrollListener, AmazingAdapter {
    ...
    public AmazingSimpleCursorAdapter(Context context, int layout, Cursor c, String[] from, int[] to) {
