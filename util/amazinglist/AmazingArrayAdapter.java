...
public abstract class AmazingArrayAdapter<T> extends ArrayAdapter<T> implements SectionIndexer, OnScrollListener, AmazingAdapter {
    ...
    public AmazingArrayAdapter(Context context, int textViewResourceId, List<T> items) {
