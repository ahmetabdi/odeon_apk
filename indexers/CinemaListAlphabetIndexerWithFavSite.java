...
public class CinemaListAlphabetIndexerWithFavSite extends DataSetObserver implements SectionIndexer {
    ...
    protected int mColumnIndexFav;
    protected Cursor mDataCursor;

    public CinemaListAlphabetIndexerWithFavSite(Cursor cursor, int sortedColumnIndex, int favouriteColumnIndex, CharSequence alphabet) {
        ...
        this.mColumnIndexFav = favouriteColumnIndex;
    }
    ...
    public int getPositionForSection(int sectionIndex) {
        ...
        while (pos < end) {
            ...
            String curName = new StringBuilder(String.valueOf(!cursor.isNull(this.mColumnIndexFav) ? "1" : "")).append(cursor.getString(this.mColumnIndex)).toString();
            if (curName == null) {
                if (pos == 0) {
                    break;
                }
    ...
    public int getSectionForPosition(int position) {
        ...
        String curName = new StringBuilder(String.valueOf(!this.mDataCursor.isNull(this.mColumnIndexFav) ? "1" : "")).append(this.mDataCursor.getString(this.mColumnIndex)).toString();
